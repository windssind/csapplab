...
0000000000400da0 <main>:
  ...
  400e44:	bf a8 23 40 00       	mov    $0x4023a8,%edi # 第二次的rdi
...
0000000000400f43 <phase_3>: # 对这道题栈区减去18有疑问 
  400f43:	48 83 ec 18          	sub    $0x18,%rsp
  400f47:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx
  400f4c:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax # 初始化
  400f5b:	e8 90 fc ff ff       	call   400bf0 <__isoc99_sscanf@plt> %
  400f60:	83 f8 01             	cmp    $0x1,%eax # 参数个数要大于1 而根据后面的可以猜出，参数个数应该是两个
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>
  400f65:	e8 d0 04 00 00       	call   40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a> # 第一个参数大于7则爆炸，所以第一个参数需要小于等于7
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax # 一个个猜
...
0000000000400fce <func4>: # rdi=第一个参数 ，rsi=0
  400fce:	48 83 ec 08          	sub    $0x8,%rsp
  400fd2:	89 d0                	mov    %edx,%eax # rdx=e
  400fd4:	29 f0                	sub    %esi,%eax # eax=e
  400fd6:	89 c1                	mov    %eax,%ecx # rcx作为拷贝
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx # ecx=0
  400fdb:	01 c8                	add    %ecx,%eax # eax=e
  400fdd:	d1 f8                	sar    %eax # 上述再算术右移一位
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx # ecx=右移一位的e
  400fe2:	39 f9                	cmp    %edi,%ecx # 和第一个参数进行比较
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24> # 如果（e变体）大于第一个参数，就不断循环（跳出循环是ecx<=arg1）
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx # edx=rcx-1
  400fe9:	e8 e0 ff ff ff       	call   400fce <func4>
  400fee:	01 c0                	add    %eax,%eax
  400ff0:	eb 15                	jmp    401007 <func4+0x39>
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax # eax=0
  400ff7:	39 f9                	cmp    %edi,%ecx # (ecx<=arg1)
  400ff9:	7d 0c                	jge    401007 <func4+0x39> # 这里是跳出函数的关键 需要参数和ecx相同
...
000000000040100c <phase_4>:
  ...
  40102c:	75 07                	jne    401035 <phase_4+0x29> # 参数个数是2
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp) # 第一个参数小于等于14
  401033:	76 05                	jbe    40103a <phase_4+0x2e>
  401035:	e8 00 04 00 00       	call   40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx # 将低的32位置为0xe
  40103f:	be 00 00 00 00       	mov    $0x0,%esi # func第二个参数为0
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi  # 第一个输入的值作为func4函数的第一个参数
...
0000000000401062 <phase_5>:
  ...
  401067:	48 89 fb             	mov    %rdi,%rbx # rdi存的是read_line函数的返回值 read_line函数的返回值是什么:输入的字符串存储的地址
  ...
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx # 第一个字符和1取and和0x4024b0的相加结果，保存到edx中
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1) # 
  4010a4:	48 83 c0 01          	add    $0x1,%rax
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax
  4010ac:	75 dd                	jne    40108b <phase_5+0x29> # 一个for 循环
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi # 逆向
...
00000000004010f4 <phase_6>:
  ...
  401106:	e8 51 03 00 00       	call   40145c <read_six_numbers> # 六个数字
  ...
  40116a:	48 39 f0             	cmp    %rsi,%rax # 循环结束条件
  40116d:	75 f1                	jne    401160 <phase_6+0x6c> # 相当于所有的参数变为7-arg
  40116f:	be 00 00 00 00       	mov    $0x0,%esi
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx # 下面这几行相当于遍历链表，找到相同的
  40117a:	83 c0 01             	add    $0x1,%eax
  40117d:	39 c8                	cmp    %ecx,%eax
  40117f:	75 f5                	jne    401176 <phase_6+0x82> # 这个是跳出程序的出口
  401181:	eb 05                	jmp    401188 <phase_6+0x94>
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2) # 这里实际上是存储的是“指针”的位置
  40118d:	48 83 c6 04          	add    $0x4,%rsi
  401191:	48 83 fe 18          	cmp    $0x18,%rsi
  401195:	74 14                	je     4011ab <phase_6+0xb7> # 所有的都已经找到了
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx
  40119a:	83 f9 01             	cmp    $0x1,%ecx
  40119d:	7e e4                	jle    401183 <phase_6+0x8f> # <=1的7-arg，直接存储0x6032d0
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax # 这两行相当于FOR循环的开始条件
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx # >1则开始遍历
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi
  4011ba:	48 89 d9             	mov    %rbx,%rcx
  4011bd:	48 8b 10             	mov    (%rax),%rdx # 循环体开始 rdx是一个中转的寄存器
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx) # 函数实际做的事情 （用下一个结点（该处的下一个结点指的是栈中的顺序存储）的值域把当前的指针给覆盖掉？）
  4011c4:	48 83 c0 08          	add    $0x8,%rax
  4011c8:	48 39 f0             	cmp    %rsi,%rax
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>
  4011cd:	48 89 d1             	mov    %rdx,%rcx
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9> # 跳转 
  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx) # 应该是六个数之中最后一个结点的指针被置为0
  4011d9:	00                        # 下面没有细看
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp # ebp=5
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax # 
  4011e3:	8b 00                	mov    (%rax),%eax # 平
  4011e5:	39 03                	cmp    %eax,(%rbx) # 指针的下一位要比第一位小，反过来了！！！！！！ 所以！！我懂了！
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa>
  4011e9:	e8 4c 02 00 00       	call   40143a <explode_bomb>
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx # 将第二个地址存入rbx
...
000000000040145c <read_six_numbers>:
  40145c:	48 83 ec 18          	sub    $0x18,%rsp # 威慑
  ...
  40148f:	83 f8 05             	cmp    $0x5,%eax # 大于5个数字才有检查的必要，不然直接bomb
...
00000000004022b0 <_IO_stdin_used>:
  ...
  4022f7:	62 65                	(bad)  
  4022f9:	72 20                	jb     40231b <_IO_stdin_used+0x6b>
  ...
  402334:	2e 2e 2e 00 57 65    	cs cs cs add %dl,0x65(%rdi)
  40233a:	6c                   	insb   (%dx),%es:(%rdi)
  40233b:	63 6f 6d             	movsxd 0x6d(%rdi),%ebp
  ...
  402391:	2e 20 48 61          	cs and %cl,0x61(%rax)
  ...
  4023b5:	65 64 2e 20 48 6f    	gs fs and %cl,%fs:0x6f(%rax)
  ...
  4023ea:	65 2e 20 20          	gs and %ah,%gs:(%rax)
  4023ee:	54                   	push   %rsp
  ...
  4023f9:	65 2e 00 00          	gs add %al,%gs:(%rax)
  ...
  402428:	62 65 65 6e 20       	(bad)
  40242d:	62 65 74 74 65       	(bad)
  402432:	72 2e                	jb     402462 <_IO_stdin_used+0x1b2>
...
00000000004024b0 <array.3449>:
  ...
  40263b:	63 6d 75             	movsxd 0x75(%rbp),%ebp
  40263e:	2e 65 64 75 00       	cs gs jne,pn 402643 <array.3449+0x193>
  402643:	61                   	(bad)  
  ...
  40264d:	2e 69 63 73 2e 63 73 	cs imul $0x2e73632e,0x73(%rbx),%esp
  402654:	2e 
  402655:	63 6d 75             	movsxd 0x75(%rbp),%ebp
  402658:	2e 65 64 75 00       	cs gs jne,pn 40265d <array.3449+0x1ad>
  40265d:	6d                   	insl   (%dx),%es:(%rdi)
  40265e:	61                   	(bad)  
  40265f:	6b 6f 73 68          	imul   $0x68,0x73(%rdi),%ebp
  402663:	61                   	(bad)  
  402664:	72 6b                	jb     4026d1 <array.3449+0x221>
  402666:	2e 69 63 73 2e 63 73 	cs imul $0x2e73632e,0x73(%rbx),%esp
  40266d:	2e 
  40266e:	63 6d 75             	movsxd 0x75(%rbp),%ebp
  402671:	2e 65 64 75 00       	cs gs jne,pn 402676 <array.3449+0x1c6>
  ...
  402695:	63 6f 6e             	movsxd 0x6e(%rdi),%ebp
  ...
  402731:	63 6f 6e             	movsxd 0x6e(%rdi),%ebp
  402734:	6e                   	outsb  %ds:(%rsi),(%dx)
  402735:	65 63 74 20 74       	movsxd %gs:0x74(%rax,%riz,1),%esi
  ...
  402760:	63 68 61             	movsxd 0x61(%rax),%ebp
  402763:	6e                   	outsb  %ds:(%rsi),(%dx)
  402764:	67 65 6d             	gs insl (%dx),%es:(%edi)
  402767:	65 2e 69 63 73 2e 63 	gs imul $0x2e73632e,%gs:0x73(%rbx),%esp
  40276e:	73 2e 
  402770:	63 6d 75             	movsxd 0x75(%rbp),%ebp
  402773:	2e 65 64 75 00       	cs gs jne,pn 402778 <array.3449+0x2c8>
  ...
  40278f:	63 73 61             	movsxd 0x61(%rbx),%esi
...
0000000000402798 <.eh_frame_hdr>:
  ...
  4027f5:	ea                   	(bad)  
  4027f6:	ff                   	(bad)  
  4027f7:	ff 70 02             	push   0x2(%rax)
  4027fa:	00 00                	add    %al,(%rax)
  4027fc:	08 eb                	or     %ch,%bl
  4027fe:	ff                   	(bad)  
  4027ff:	ff 90 02 00 00 5e    	call   *0x5e000002(%rax)
  ...
  40284d:	ed                   	in     (%dx),%eax
  40284e:	ff                   	(bad)  
  40284f:	ff b0 03 00 00 2c    	push   0x2c000003(%rax)
  402855:	ee                   	out    %al,(%dx)
  402856:	ff                   	(bad)  
...
00000000004028a0 <__FRAME_END__-0x450>:
  ...
  402993:	ff 92 00 00 00 00    	call   *0x0(%rdx)
  ...
  402b73:	ff 95 00 00 00 00    	call   *0x0(%rbp)
...
0000000000602df8 <__frame_dummy_init_array_entry>:
  ...
  602dfa:	40 00 00             	rex add %al,(%rax)
...
0000000000602e10 <_DYNAMIC>:
  ...
  602f29:	07                   	(bad)  
  602f2a:	40 00 00             	rex add %al,(%rax)
  ...
  602f5a:	40 00 00             	rex add %al,(%rax)
  ...
  602f79:	07                   	(bad)  
  602f7a:	40 00 00             	rex add %al,(%rax)
	...
...
0000000000602fe8 <_GLOBAL_OFFSET_TABLE_>:
  ...
  603020:	26 0b 40 00          	es or  0x0(%rax),%eax
  603024:	00 00                	add    %al,(%rax)
  603026:	00 00                	add    %al,(%rax)
  603028:	36 0b 40 00          	ss or  0x0(%rax),%eax
  ...
  60304a:	40 00 00             	rex add %al,(%rax)
  ...
  603082:	40 00 00             	rex add %al,(%rax)
...
0000000000603340 <host_table>:
  ...
  603352:	40 00 00             	rex add %al,(%rax)
	...
...
0000000000000000 <.comment>:
  ...
  3d:	34 
  3e:	2e 36 2e 33 2d 31 75 	cs ss cs xor 0x75627531(%rip),%ebp        # 75627578 <_end+0x75023768>
  45:	62 75 
  47:	6e                   	outsb  %ds:(%rsi),(%dx)
  48:	74 75                	je     bf <_init-0x400a01>
  4a:	35 29 20 34 2e       	xor    $0x2e342029,%eax
  4f:	36 2e 33 00          	ss cs xor (%rax),%eax
...
0000000000000000 <.debug_info>:
 ...
 162:	06                   	(bad)  
 163:	26 01 6c 02 00       	es add %ebp,0x0(%rdx,%rax,1)
 ...
 18a:	2e 01 70 00          	cs add %esi,0x0(%rax)
...
0000000000000000 <.debug_abbrev>:
  ...
  9c:	0b 00                	or     (%rax),%eax
  9e:	00 0e                	add    %cl,(%rsi)
  a0:	26 00 49 13          	es add %cl,0x13(%rcx)
  a4:	00 00                	add    %al,(%rax)
  ...
  e0:	12 07                	adc    (%rdi),%al
  e2:	40 18 97 42 19 01 13 	rex sbb %dl,0x13011942(%rdi)
  e9:	00 00                	add    %al,(%rax)
 ...
 20d:	26 2e 01 3f          	es cs add %edi,(%rdi)
...
0000000000000000 <.debug_str>:
 ...
 1ac:	62 75                	(bad)  
 1ae:	69 6c 74 69 6e 5f 70 	imul   $0x75705f6e,0x69(%rsp,%rsi,2),%ebp
 1b5:	75 
 ...
 1dd:	63 6b 5f             	movsxd 0x5f(%rbx),%ebp
 ...
 22e:	62                   	(bad)  
 22f:	2e 63 00             	cs movsxd (%rax),%eax
